...
shap_values += np.random.random(shap_values.shape) * 1e-7 # Add Small Random Noise to prevent ties
...
shap_values_val += np.random.random(shap_values_val.shape) * 1e-7 # Add Small Random Noise to prevent ties
